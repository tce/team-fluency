"""
Trial Viewer — Trials 45, 46, 47, 48
==========================================
Shows the game grid and live metrics. No charts.

Requires:
  - trials_45_to_48.json  (in same folder as this script)
  - pygame
...
DATA_FILE = os.path.join(BASE, 'trials_45_to_48.json')
COOK_TIME = 20
FPS       = 12

TRIAL_IDS = ['45', '46', '47', '48']
...
def main():
    if not os.path.exists(DATA_FILE):
        ...
        print("Make sure trials_45_to_48.json is in the same folder as this script.")
        sys.exit(1)
    ...
    pygame.display.set_caption('Overcooked Trial Viewer — Trials 45–48')
