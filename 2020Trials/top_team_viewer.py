"""
Top Team Viewer — 2020 Dataset, All 8 Layouts
==============================================
...
Requires:
  - top_team_all_layouts.json  (same folder as this script)
  - pygame
...
DATA_FILE = os.path.join(BASE, 'top_team_all_layouts.json')
FPS       = 12
...
def main():
    if not os.path.exists(DATA_FILE):
        ...
        print("Make sure top_team_all_layouts.json is in the same folder.")
        sys.exit(1)
    ...
    pygame.display.set_caption('Top Team Viewer — 2020 Dataset')
