"""
Best Score Per Layout Viewer — 2020 Dataset, All 8 Layouts
==============================================
...
Requires:
  - best_score_per_layout.json  (same folder as this script)
  - pygame
...
DATA_FILE = os.path.join(BASE, 'best_score_per_layout.json')
FPS       = 12
...
def main():
    if not os.path.exists(DATA_FILE):
        ...
        print("Make sure best_score_per_layout.json is in the same folder.")
        sys.exit(1)
    ...
    pygame.display.set_caption('Best Score Per Layout Viewer — 2020 Dataset')
